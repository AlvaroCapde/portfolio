                ...
                <div className="container mx-auto w-full h-full">
                    <div className=" wrap overflow-hidden p-10 h-full">
                        <div className="mb-8 flex justify-between items-center w-full right-timeline">
                            ...
                            <div className="order-1 bg-purple-200 rounded-lg shadow-xl md:w-5/12 w-full px-6 py-4">
                        ...
                        <div className="mb-8 flex justify-between flex-row-reverse items-center w-full left-timeline">
                            ...
                            <div className="order-1 bg-slate-400 rounded-lg shadow-xl md:w-5/12 w-full px-6 py-4">
                        ...
                        <div className="mb-8 flex justify-between items-center w-full right-timeline">
                            ...
                            <div className="order-1 bg-white-600 rounded-lg shadow-xl md:w-5/12 w-full px-6 py-4">
